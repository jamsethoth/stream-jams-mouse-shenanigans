...
- Drive the seam-provided interactive desktop test fixture for foreground-window and global-hotkey scenarios when the test runner has a real Windows user session.
