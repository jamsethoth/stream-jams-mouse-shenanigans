# Game Safety Guardrails

## Purpose

Define local game-safety policy that blocks runtime remapping for games unless explicitly permitted, exits MouseShenanigans when disallowed games are detected, and avoids invasive game or anti-cheat integration.
